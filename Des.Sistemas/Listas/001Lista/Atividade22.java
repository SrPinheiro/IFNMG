...
public class Atividade22 {
    public static void main(String[] args) {
        /*Construa um programa que exiba um menu com 5 opções: 1 - Somar, 2 – Subtrair, 3-
         Multiplicar, 4 – Dividir e 5 - Sair. Ao escolher uma das opções o programa deve solicitar
         que o usuário informe dois números, calcular a operação escolhida e imprimir o
         resultado e retornar ao menu, caso o usuário informe a opção 5, o programa deverá ser finalizado.*/
